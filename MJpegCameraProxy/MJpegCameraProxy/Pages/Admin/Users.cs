...
namespace MJpegCameraProxy.Pages.Admin
{
	class Users : AdminBase
	{
		...
		{
			ItemTable<Configuration.User> tbl = new ItemTable<Configuration.User>("Users", "user", "name", MJpegWrapper.cfg.users, MJpegWrapper.cfg, new ItemTableColumnDefinition<Configuration.User>[]
			{
